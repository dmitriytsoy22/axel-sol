...
export function InvestmentDetails({ project }: InvestmentDetailsProps): React.JSX.Element {
  ...
  const details = [
    ...
    { label: t('totalSupply'), value: project.totalTokenSupply.toLocaleString() },
    { label: t('tokensSold'), value: project.tokensSold.toLocaleString() },
    { label: t('mintAddress'), value: <AddressLink address={project.mint} /> },
    { label: t('revenueVault'), value: <AddressLink address={project.revenueVault} /> },
  ];
